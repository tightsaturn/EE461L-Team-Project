...
public class UINavigationTest {
    ...
    public void t1() {
        ...
        wd.findElement(By.cssSelector("div.col-lg-4:nth-child(1) > div:nth-child(1) > div:nth-child(3) > a:nth-child(1) > button:nth-child(1)")).click();
        String url = wd.getCurrentUrl();
    ...
    public void t3() throws InterruptedException {
        ...
        String url = wd.getCurrentUrl();
        assertEquals("https://togepedia.appspot.com/moves/1", url);
        wd.quit();
    }
    ...
    public void t8() throws InterruptedException {
        ...
        wd.findElement(By.cssSelector(".container-fluid > div:nth-child(6) > button:nth-child(1)")).click();
        url = wd.getCurrentUrl();
        assertEquals("https://togepedia.appspot.com/teambuilder/change/1/1", url);
        wd.quit();
    }
